...
func UIFontAvenirNextRegular(size: CGFloat) -> UIFont {
    return UIFont(name: "AvenirNext-Regular", size: 40)!
}

func UIFontAvenirNextMedium(size: CGFloat) -> UIFont {
    return UIFont(name: "AvenirNext-Medium", size: 40)!
}
...
public class AppusCircleTimer: UIView {
    ...
    let FONT = UIFontAvenirNextBold(size: 40)
    ...
    public var isActive = true {
        didSet(newValue) {
            if newValue {
                ...
                timerLabel?.font = UIFontAvenirNextBold(size: 40)
            } else {
    ...
    public weak var timerLabel : UILabel?
    ...
    private func addBaseSubviews() {
        ...
        label.font = UIFontAvenirNextBold(size: 40)
