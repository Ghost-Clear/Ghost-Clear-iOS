...
class DoTimedWorkoutViewController: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, CBPeripheralManagerDelegate, AppusCircleTimerDelegate {
	...
	// function to store information about a visited corner
	...
	// the following functions define how to write to a device
	...
	// functions to initialize bluetooth data and connect to devices
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        data.length = 0
        peripheral.delegate = self
        //Only look for services that matches the device UUID
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        // look for the read and write characteristics of the device and save them
