...
import UIKit
import M13Checkbox
class ProWorkoutConnectionProgressViewController: UIViewController {
	@IBOutlet var circleView : CircularProgressView!
	@IBOutlet weak var checkBox: M13Checkbox!
	@IBOutlet weak var containingView: UIView!
	@IBOutlet weak var connectionLabel: UILabel!
	var parentView : DoProWorkoutViewController!
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		DispatchQueue.main.asyncAfter(deadline: .now() + 2.1) {
			...
			if (self.parentView.FRPeripheral == nil) || (self.parentView.FLPeripheral == nil) || (self.parentView.CRPeripheral == nil) || (self.parentView.CLPeripheral == nil) || (self.parentView.LRPeripheral == nil) || (self.parentView.LLPeripheral == nil){
